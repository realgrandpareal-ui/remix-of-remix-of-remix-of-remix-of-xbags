...
const posts = [
  {
    ...
    avatar: "AC",
    time: "2h ago",
    content: "Just launched my new NFT collection 🎨 Check it out! The future of digital art is here.",
    likes: 142,
    comments: 23,
    shares: 8,
  ...
  },
  {
    ...
    avatar: "SK",
    time: "4h ago",
    content: "Building in public day 45: Finally hit 10K followers on CreatorSpace! Thank you everyone for the support 🚀",
    likes: 389,
    comments: 67,
    shares: 24,
          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className={`h-10 w-10 rounded-full flex items-center justify-center text-sm font-bold ${post.color}`}>
                  {post.avatar}
                </div>
                <div>
            ...
            <div className="flex items-center gap-1">
              ...
              <Button variant="ghost" size="sm" className="gap-1.5 text-muted-foreground hover:text-primary text-xs">
